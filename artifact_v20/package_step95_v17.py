"""Create and stream-audit the deterministic Step 95 / V17 review ZIP."""
...
SOURCE = ROOT / "STEP95_ANONYMOUS_ARTIFACT_RELEASE_CANDIDATE_V17"
MANIFEST_NAME = "STEP82_RELEASE_MANIFEST.json"
ARCHIVE = ROOT / "STEP95_ANONYMOUS_REVIEW_ARTIFACT_V17_2026-08-13.zip"
SIDECAR = ROOT / f"{ARCHIVE.name}.sha256"
AUDIT = ROOT / "STEP95_V17_ZIP_STREAM_AUDIT_2026-08-13.json"
...
def main() -> None:
    ...
    if manifest.get("schema") != "step95.anonymous_validation_closure_release.v11":
        raise AssertionError("unexpected V17 manifest schema")
    ...
    report = {
        "verdict": "PASS_STEP95_V17_ZIP_STREAM_AUDIT" if not failures else "FAIL_STEP95_V17_ZIP_STREAM_AUDIT",
