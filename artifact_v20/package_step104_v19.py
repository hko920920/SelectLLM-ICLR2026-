"""Create and stream-audit the deterministic Step 104 / V19 review ZIP."""
...
SOURCE = ROOT / "STEP104_ANONYMOUS_ARTIFACT_RELEASE_CANDIDATE_V19"
MANIFEST_NAME = "STEP82_RELEASE_MANIFEST.json"
ARCHIVE = ROOT / "STEP104_ANONYMOUS_REVIEW_ARTIFACT_V19_2026-08-13.zip"
SIDECAR = ROOT / f"{ARCHIVE.name}.sha256"
AUDIT = ROOT / "STEP104_V19_ZIP_STREAM_AUDIT_2026-08-13.json"
...
def main() -> None:
    ...
    if manifest.get("schema") != "step104.anonymous_validation_closure_release.v13":
        raise AssertionError("unexpected V19 manifest schema")
    ...
    with zipfile.ZipFile(ARCHIVE, "r") as bundle:
        ...
        if hashlib.sha256(bundle.read(MANIFEST_NAME)).hexdigest() != sha256(manifest_path):
    ...
    report = {
        "verdict": "PASS_STEP104_V19_ZIP_STREAM_AUDIT" if not failures else "FAIL_STEP104_V19_ZIP_STREAM_AUDIT",
