"""Create and stream-audit the deterministic Step 97 / V18 review ZIP."""
...
SOURCE = ROOT / "STEP97_ANONYMOUS_ARTIFACT_RELEASE_CANDIDATE_V18"
MANIFEST_NAME = "STEP82_RELEASE_MANIFEST.json"
ARCHIVE = ROOT / "STEP97_ANONYMOUS_REVIEW_ARTIFACT_V18_2026-08-13.zip"
SIDECAR = ROOT / f"{ARCHIVE.name}.sha256"
AUDIT = ROOT / "STEP97_V18_ZIP_STREAM_AUDIT_2026-08-13.json"
...
def main() -> None:
    ...
    if manifest.get("schema") != "step97.anonymous_validation_closure_release.v12":
        raise AssertionError("unexpected V18 manifest schema")
    ...
    report = {
        "verdict": "PASS_STEP97_V18_ZIP_STREAM_AUDIT" if not failures else "FAIL_STEP97_V18_ZIP_STREAM_AUDIT",
