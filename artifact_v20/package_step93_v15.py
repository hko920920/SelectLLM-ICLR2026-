"""Create and stream-audit the deterministic Step 93 / V15 review ZIP."""
...
SOURCE = ROOT / "STEP93_ANONYMOUS_ARTIFACT_RELEASE_CANDIDATE_V15"
MANIFEST_NAME = "STEP82_RELEASE_MANIFEST.json"
ARCHIVE = ROOT / "STEP93_ANONYMOUS_REVIEW_ARTIFACT_V15_2026-08-13.zip"
SIDECAR = ROOT / f"{ARCHIVE.name}.sha256"
AUDIT = ROOT / "STEP93_V15_ZIP_STREAM_AUDIT_2026-08-13.json"
...
def main() -> None:
    ...
    if manifest.get("schema") != "step93.anonymous_validation_closure_release.v9":
        raise AssertionError("unexpected V15 manifest schema")
    ...
    report = {
        "verdict": (
            "PASS_STEP93_V15_ZIP_STREAM_AUDIT"
            if not failures
            else "FAIL_STEP93_V15_ZIP_STREAM_AUDIT"
        ),
