...
# In the public handoff repository, the immutable machine-readable evidence
# lives in the byte-preserved V20 artifact rather than beside this convenience
# copy of the current manuscript.
ROOT = HERE.parent / "artifact_v20"
